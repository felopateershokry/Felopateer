...
export const projects = [
  {
    ...
    descriptionCard:
      "A complete e-commerce solution with authentication, cart, and payments.",
    description:
      "A complete e-commerce solution with authentication, cart, and payments.",
  ...
  },
  {
    ...
    descriptionCard: "Production-ready REST API with JWT authentication.",
  ...
  },
  {
    ...
    descriptionCard: "Real-time dashboard with charts and analytics.",
  ...
  },
  {
    ...
    descriptionCard:
      "Modern personal portfolio with animations, responsive layout, and custom UI design.",
    description:
      "Modern personal portfolio with animations, responsive layout, and custom UI design.",
